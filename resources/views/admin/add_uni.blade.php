            ...
            <div class="card">
                <div class="card-header" style="background:black; color:white;">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto"> 
                            <h3 style="margin-bottom: 0px !important"><b>Add New University</b></h3>
                        </div>
                    </div>
                </div>
                <form action="{{route('admin.submit_uni')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        @if (session('success'))
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="university_name" type="text" class="form-control" name="university_name" value="" placeholder="Universiti Malaya" required autofocus>
                            </div>
                        </div>
                        <div class="row mb-4">
