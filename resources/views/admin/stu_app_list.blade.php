            ...
            <div class="card">
                <div class="card-header" style="background:black; color:white;">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto"> 
                            <h3 style="margin-bottom: 0px !important"><b>Student Application List</b></h3>
                        </div>
                    </div>
                </div>
                            ...
                            @if(isset($students))
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <div class="btn-group">
                                            <a href="{{route('admin.view_stu_app', ['id'=>$stu->id])}}">
                                            ...
                                            <form action="{{route('admin.delete_uni')}}" method="POST">
                                                @csrf
                                                <input type="text" value="{{$stu->id}}" name="uni_id" hidden>
