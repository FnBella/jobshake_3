            ...
            <nav id="sidebarMenu" class="d-lg-block sidebar offcanvas offcanvas-start" data-bs-backdrop="false" tabindex="-1" aria-labelledby="offcanvasExampleLabel" style="background:#fff7eb;">
                ...
                <div class="position-sticky">
                    <div class="list-group list-group-flush mx-3 mt-1">
                        <a href="{{route('employer.home')}}" class="list-group-item list-group-item-action py-3 ripple align-items-center d-flex {{ (request()->is('employer')) ? 'active' : '' }}">
                            <i class="fas fa-tachometer-alt fa-lg fa-fw me-3"></i><span class="m">Dashboard</span>
                        </a>
                        <a href="{{route('employer.company_profile')}}" class="list-group-item list-group-item-action py-3 ripple align-items-center d-flex {{ (request()->is('employer/company_profile') || request()->is('employer/edit_profile/*')) ? 'active' : '' }}">
                            <i class="fas fa-building fa-lg fa-fw me-3"></i><span class="m">Company Profile</span>
                        </a>
                        <a href="{{route('employer.student_list')}}" class="list-group-item list-group-item-action py-3 ripple align-items-center d-flex {{ (request()->is('employer/student_list?page=?*') || request()->is('employer/student_list') || request()->is('employer/view_student/*') || request()->is('employer/filter_student_list')) ? 'active' : '' }}">
                            <i class="fas fa-graduation-cap fa-lg fa-fw me-3"></i><span class="m">Student List</span>
                        </a>
                        <a href="{{route('employer.job_list')}}" class="list-group-item list-group-item-action py-3 ripple align-items-center d-flex {{ (request()->is('employer/job_list') || request()->is('employer/view_job_details/*')) ? 'active' : '' }}">
                            <i class="fas fa-briefcase fa-lg fa-fw me-3"></i><span class="m">Job List</span>
                        </a>
                        <a href="{{route('employer.rating_list')}}" class="list-group-item list-group-item-action py-3 ripple align-items-center d-flex {{ (request()->is('employer/rating_list')) ? 'active' : '' }}">
                            <i class="fas fa-star fa-lg fa-fw me-3"></i><span class="m">Company Rating</span>
                        </a>
                        <a href="{{route('employer.chat_list')}}" class="list-group-item list-group-item-action py-3 ripple align-items-center d-flex {{ (request()->is('employer/chat_list')) ? 'active' : '' }}">
                            <i class="fas fa-comments fa-lg fa-fw me-3"></i><span class="m">Company Chat</span>
                        </a>
                    </div>
                </div>
            </nav>
                            ...
                            <ul class="navbar-nav ms-auto d-flex flex-row">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img src="{{ asset('archieve/company_logo/'.Auth::user()->employer->company_logo) }}" class="rounded-circle" height="80" alt="" />
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                                        <li><a class="dropdown-item" href="{{route('employer.company_profile')}}">My profile</a></li>
                                        <li>
