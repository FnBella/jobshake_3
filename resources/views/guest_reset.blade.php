                ...
                <div class="col-md-7">
                    <div class="card" style="margin-top: 50px !important; margin-bottom: 80px !important;">
                        <div class="card-header text-center" style="background:#d9a760; color:black;">
                            <h2 style="margin-bottom: 0px !important;"><b>Reset Password</b></h2>
                        </div>
                        ...
                        <div class="card-body" style="padding: 0px !important;">
                            ...
                            <div class="row justify-content-center" style="margin-left: 0px !important; margin-right: 0px !important;">
                                <div class="col-md-6 align-items-center">
                                    <form method="POST" action="{{ route('guest.reset_update_password') }}">
                                        @csrf
                                        <div class="row mb-3" style="margin-top:100px;">
                                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>

                                            <div class="col-md-6">
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter Your Email..." name="email" value="{{ $user->email }}" required autocomplete="email" readonly>
                                                <input type="text" name="id" value="{{ $user->id }}" hidden>
                                                <input type="text" name="profile_id" value="{{ $user->profile_id }}" hidden>
                                                <input type="text" name="type" value="{{ $user->is_admin }}" hidden>
                                                @error('email')
