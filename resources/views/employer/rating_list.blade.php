...
.pie-wrapper .label { /*percentage no*/
  position: absolute;
  top: 0.52em;
  right: 0.4em;
  bottom: 0.4em;
...
.pie-wrapper .smaller {  /*percentage %*/
  padding-bottom: 20px;
  color: #BDC3C7;
  font-size: 0.45em;
                        ...
                        <div class="col-md-8">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Student Name - Job Title & Rating</th>
                                    ...
                                    <tbody>
                                        @foreach($rates as $rating)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-md-12">
                                                        {{$rating->job->student->full_name}} - {{$rating->job->job_name}}
                                                    </div>
                                                    <div class="col-md-12">
    ...
    // function showChart(){
        ...
        function updateDonutChart (el, percent, donut) {
            ...
            if(percent = 0 && percent <= 50){
                ...
                rep += '<p class="per_rep">Company need to improved. Increase payment rate, give reasonable task, give reasonable duration time, and try to communicate more with students or freelancers.</p>';
                ...
                rep += '<p class="per_rep">Students and freelancers satisfied with the offer given by company, however there are some improvement can be made to increase company reputation and ratings.</p>';
                ...
                rep += '<p class="per_rep">Most students and freelancers thinks this company is good. Keep it up !</p>';
