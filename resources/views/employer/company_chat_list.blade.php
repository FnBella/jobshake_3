            ...
            <div class="card" style="margin-bottom: 50px;">
                <div class="card-header" style="background:#d29d51; color:white;">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto"> 
                            <h3 style="margin-bottom: 0px !important"><b>Company Chat List</b></h3>
                        </div>
                        <!-- <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto my-3">
                                            <img src="{{asset('archieve/profile/'.$chat->student->profile_pic)}}" class="rounded-circle" alt="" height="50px" width="50" style="border: 2px solid black; background:white;">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto align-items-center d-flex">
                                    <div class="row">
                                        <div class="col-md-12" style="font-size: 20px; padding: 10px;">
                                            <span>{{$chat->student->full_name}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title student_name" id="exampleModalLabel">
                </h5>
    ...
    $(document).on('click', '#my_chat', function(){
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                $('.student_name').text(data.student.full_name);
