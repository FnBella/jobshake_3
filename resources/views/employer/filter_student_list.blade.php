            ...
            <div class="card" style="margin-bottom: 50px; width:auto;">
                <div class="card-header" style="background:#d29d51; color:white;">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto"> 
                            <h3 style="margin-bottom: 0px !important"><b>Filter Student List By Field</b></h3>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body" style="background:#fff7eb;">
                    ...
                    <div class="row my-3 justify-content-between">
                        @if($stus != "0")
                            @foreach($stus as $stu)
                                <a href="{{route('employer.view_student', ['id'=>$stu->id])}}" class="col-auto list_stu" style="margin-bottom:20px !important">
